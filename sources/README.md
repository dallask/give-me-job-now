...
- **Vacancy dumps**: prefer `vacancies/` for scraped listings; research briefs in `research/`

Do not commit secrets or highly sensitive personal data unless you intend to keep this repository private.
