...
description: From a pasted CV design screenshot, generate a reusable HTML/Jinja2 template under templates/cv/ that binds candidate.* (Phase-9 schema), matched to the design via the WeasyPrint compare==ship visual-diff loop. Injects the @font-face DejaVu rule for Cyrillic. Spoke — never calls Task. [EXPERIMENTAL — Cursor adapter, generated from .claude/agents/gmj-template-creator.md — see gmj-core/bin/CURSOR-HOOK-PARITY.md]
model: inherit
readonly: false
---

<!-- GENERATED FILE — DO NOT HAND-EDIT.
     Source: .claude/agents/gmj-template-creator.md
     Generated by: gmj-core/bin/gmj-cursor-adapter.cjs (EXPERIMENTAL — see gmj-core/bin/CURSOR-HOOK-PARITY.md)
     Original Claude Code tools grant (coarser here as readonly:false — precision loss documented in CURSOR-HOOK-PARITY.md): Read, Bash, Glob, LS, Write
-->
