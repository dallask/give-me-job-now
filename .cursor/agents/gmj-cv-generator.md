...
description: Generates CV PDF from config/candidate.yaml using Python gmj_render_cv.py. Supports optional Jinja HTML template with WeasyPrint if installed; otherwise ReportLab built-in layout. [EXPERIMENTAL — Cursor adapter, generated from .claude/agents/gmj-cv-generator.md — see gmj-core/bin/CURSOR-HOOK-PARITY.md]
model: inherit
readonly: false
---

<!-- GENERATED FILE — DO NOT HAND-EDIT.
     Source: .claude/agents/gmj-cv-generator.md
     Generated by: gmj-core/bin/gmj-cursor-adapter.cjs (EXPERIMENTAL — see gmj-core/bin/CURSOR-HOOK-PARITY.md)
     Original Claude Code tools grant (coarser here as readonly:false — precision loss documented in CURSOR-HOOK-PARITY.md): Read, Bash, Glob, LS
-->
