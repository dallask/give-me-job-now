...
description: Ingests candidate materials from sources/candidate/ (pdf, docx, txt, images, and authorized credential URLs), routing each by type. Proposes machine-mergeable findings + a coverage manifest for the configurator. Never writes the master YAML; does not spawn subagents. [EXPERIMENTAL — Cursor adapter, generated from .claude/agents/gmj-candidate-analyzer.md — see gmj-core/bin/CURSOR-HOOK-PARITY.md]
model: inherit
readonly: false
---

<!-- GENERATED FILE — DO NOT HAND-EDIT.
     Source: .claude/agents/gmj-candidate-analyzer.md
     Generated by: gmj-core/bin/gmj-cursor-adapter.cjs (EXPERIMENTAL — see gmj-core/bin/CURSOR-HOOK-PARITY.md)
     Original Claude Code tools grant (coarser here as readonly:false — precision loss documented in CURSOR-HOOK-PARITY.md): Read, Bash, Glob, Grep, WebFetch
-->
