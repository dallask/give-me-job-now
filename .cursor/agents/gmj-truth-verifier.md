...
description: Gate A — verifies every artifact claim traces to config/candidate.yaml; a non-bypassable truth hard-block before fit scoring. Does not spawn subagents. [EXPERIMENTAL — Cursor adapter, generated from .claude/agents/gmj-truth-verifier.md — see gmj-core/bin/CURSOR-HOOK-PARITY.md]
model: inherit
readonly: true
---
