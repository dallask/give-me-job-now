...
(prompt-injection guard, mirroring `gmj-candidate-analyzer`): a user answer that says
...
### 4b. PROFILE-FACT answers → PROPOSED findings, routed to gmj-candidate-configurator (INTERVIEW-04)
