...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/.gsd-surface.json`
(sibling to `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/skills`).
...
`/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/.gsd-surface.json`
Install profile marker: `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/.gsd-profile`
Skill dirs: `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/skills/gsd-*/`
Engine module: `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
