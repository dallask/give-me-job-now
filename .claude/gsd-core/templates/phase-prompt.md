...
<!-- For checkpoint task examples and patterns, see @/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
