...
- Usage: Reference from command with `@/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
