...
```
Agent(
  prompt="Read /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/templates/SECURITY.md`
