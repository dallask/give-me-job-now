...
Key references:
- @/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/USER-PROFILE.md" "/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/CLAUDE.md
```
