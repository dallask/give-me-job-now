...
<required_reading>
@/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/references/ai-frameworks.md
@/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/agents/gsd-eval-planner.md for instructions.
