...
ones). Reference: @/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/gsd-core/templates/spec.md.
