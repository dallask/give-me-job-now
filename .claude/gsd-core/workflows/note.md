...
- **Global scope**: `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/notes/`)
...
2. Glob `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/Ievgen_Kyvgyla/tmp/give-me-job/.claude/notes/` — works in any directory
