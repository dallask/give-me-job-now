...
```agent_result_v1
{
  ...
  "agent": "gmj-artifact-composer",
  "pipeline_run_id": "20260101T000000-000000",
  "status": "success",
  "artifacts": [{"type": "file", "path": "/abs/path/output/artifacts/<offer-slug>/cv.draft.json"}],
  "acceptance_criteria_met": ["crit-draft-written"],
  "acceptance_criteria_failed": [],
  "next_action": "none",
  "handoff_target": null,
  "notes": "Composed cv draft from candidate.yaml + offer_spec"
}
```
