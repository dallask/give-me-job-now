...
**PASS criteria:**
- A human operator confirms the observed output/state matches OPS-02's documented behavior above by reading the real output, not by delegating to a script's exit code alone.
