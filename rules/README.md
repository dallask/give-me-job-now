...
| `sources-scope.md` | glob `config/sources.yaml`; keywords web-search, WebFetch; agents gmj-offer-scout, vacancy-scraper | You run any web search / offer discovery — stay inside `config/sources.yaml` boards/geos/langs; read it first. |
